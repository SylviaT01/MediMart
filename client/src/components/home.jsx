      ...
      <section className="py-20">
        <div className="container mx-auto px-4 ">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 h-60">
            ...
            <div className="relative bg-white rounded-lg shadow-lg overflow-hidden">
              <img src="https://img.freepik.com/free-photo/african-american-courier-going-though-check-list-while-carrying-packages-walking-down-street_637285-1224.jpg?t=st=1720208256~exp=1720211856~hmac=b988863e32b61e1fe245e1904ec0094a7ba66d757c12d7bd40c300ca8af8c849&w=740" alt="Quality Products" className="w-full h-full object-cover opacity-70" />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center p-6 text-white">
            ...
            <div className="relative bg-white rounded-lg shadow-lg overflow-hidden">
              <img src="https://img.freepik.com/free-photo/two-african-american-pharmacist-working-drugstore-hospital-pharmacy-african-healthcare_627829-3327.jpg?t=st=1720208457~exp=1720212057~hmac=aaa7bd2ae583fb084a2f1e0c8a6dbf75793dbd8001ddea8e511de52e7e312a18&w=740" alt="Quality Products" className="w-full h-full object-cover opacity-70" />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center p-6 text-white">
